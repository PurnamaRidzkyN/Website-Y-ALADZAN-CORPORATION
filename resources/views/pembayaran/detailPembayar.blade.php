            ...
            <div class="container mx-auto px-6 lg:px-8">
                ...
                <div class="bg-[#1A2634] border border-[#2D3748] rounded-lg shadow-lg p-6 mb-6">
                    <ul class="list-none text-[#E2E8F0]">
                        ...
                        <li class="detail-item text-[#F7FAFC] mb-4"><strong>Deskripsi:</strong>
                            {{ $loans->description }}
                        </li>
                    ...
                    @foreach ($payments as $payment)
                        ...
                        <div class="modal fade" id="editPaymentModal-{{ $payment->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" style="background-color: #2D3748; color: #F7FAFC;">
                                    <div class="modal-header" style="background-color: #1A2634;">
                                        <h5 class="modal-title" id="editModalLabel{{ $payment->id }}">Edit
                                            Pembayaran
                                        </h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    ...
                                    <div class="modal-body" style="background-color: #2D3748;">
                                        ...
                                        <form
                                            ...
                                            <!-- Input Deskripsi -->
                                            <div class="mb-3">
                                                <label for="payment_description{{ $payment->id }}"
                                                    class="form-label" style="color: #fff;">Deskripsi</label>
                ...
                <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mt-4">
                    ...
                    <button
                        class="px-6 py-3 bg-[#3182CE] text-white rounded-lg hover:bg-[#1E40AF] transition-all w-full md:w-1/3 mb-2 md:mb-0"
                        onclick="sendWhatsapp()">
                        Kirim Pemberitahuan WA
                    </button>

                    <!-- Button Edit Data -->
                    <button
                        class="btn btn-warning px-6 py-3 text-white rounded-lg hover:bg-[#D97706] transition-all w-full md:w-1/3 mb-2 md:mb-0"
                    ...
                    <!-- Button Delete Data -->
                    <button type="button"
                        class="btn btn-danger px-6 py-3 text-white rounded-lg hover:bg-[#9B2C2C] transition-all w-full md:w-1/3  mb-2 md:mb-0"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control formattedNominal"
                                                    ...
                                                    required>
                                                <input type="hidden" class="form-control nominal"
                                                    name="total_amount"
                                                    value="{{ number_format(floor($loans->total_amount), 0, '', '') }}"
                                                    required>
                                            </div>
